...
package com.doing.flat.coffee.xutils.db.table;


import android.text.TextUtils;

import com.doing.flat.coffee.xutils.db.annotation.Check;
import com.doing.flat.coffee.xutils.db.annotation.NotNull;
import com.doing.flat.coffee.xutils.db.annotation.Transient;
import com.doing.flat.coffee.xutils.db.annotation.Unique;
import com.doing.flat.coffee.xutils.db.annotation.Column;
import com.doing.flat.coffee.xutils.db.annotation.Id;
import com.doing.flat.coffee.xutils.db.annotation.Finder;
import com.doing.flat.coffee.xutils.db.annotation.Foreign;
import com.doing.flat.coffee.xutils.db.converter.ColumnConverter;
import com.doing.flat.coffee.xutils.db.converter.ColumnConverterFactory;
import com.doing.flat.coffee.xutils.db.sqlite.FinderLazyLoader;
import com.doing.flat.coffee.xutils.db.sqlite.ForeignLazyLoader;
import com.doing.flat.coffee.xutils.util.LogUtils;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.doing.flat.coffee.xutils.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.doing.flat.coffee.xutils.db.table.Finder finderColumn) {
