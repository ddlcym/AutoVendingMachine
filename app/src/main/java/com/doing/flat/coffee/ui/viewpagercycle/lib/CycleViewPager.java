package com.doing.flat.coffee.ui.viewpagercycle.lib;
...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
    ...
    public void setData(List<View> views, List<ADInfo> list, ImageCycleViewListener listener) {
     ...
     */
    public void setData(List<View> views, List<ADInfo> list, ImageCycleViewListener listener, int showPosition) {
    ...
    public void onPageSelected(int arg0) {
        ...
        if (position < infos.size()) {
            if (infos.get(position).getRemain_time() != null)
                time = Integer.parseInt(infos.get(position).getRemain_time())*1000;
            if (!infos.get(position).getFile_type().equals("1")) {
                if (mImageCycleViewListener != null) {
                            mImageCycleViewListener.onIndicator(infos.get(position), position);
                }
            }
        }
...
//					.setBackgroundResource(R.drawable.icon_point_pre);
    ...
    public static interface ImageCycleViewListener {
        ...
        public void onIndicator(ADInfo info, int postio);
    }
}