...
import com.doing.flat.coffee.download.error.FileAlreadyExistException;
import com.doing.flat.coffee.download.error.NoMemoryException;
import com.doing.flat.coffee.download.http.AndroidHttpClient;
