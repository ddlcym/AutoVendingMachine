...
package com.doing.flat.coffee.xutils;
...
import com.doing.flat.coffee.xutils.db.sqlite.CursorUtils;
import com.doing.flat.coffee.xutils.db.sqlite.DbModelSelector;
import com.doing.flat.coffee.xutils.db.sqlite.Selector;
import com.doing.flat.coffee.xutils.db.sqlite.SqlInfo;
import com.doing.flat.coffee.xutils.db.sqlite.SqlInfoBuilder;
import com.doing.flat.coffee.xutils.db.sqlite.WhereBuilder;
import com.doing.flat.coffee.xutils.db.table.DbModel;
import com.doing.flat.coffee.xutils.db.table.Id;
import com.doing.flat.coffee.xutils.db.table.Table;
import com.doing.flat.coffee.xutils.db.table.TableUtils;
import com.doing.flat.coffee.xutils.exception.DbException;
import com.doing.flat.coffee.xutils.util.IOUtils;
...
public class DbUtils {
    ...
    public void update(Object entity, WhereBuilder whereBuilder, String... updateColumnNames) throws DbException {
        ...
        try {
            beginTransaction();
//            Log.e("SqlInfoBuilder", SqlInfoBuilder.buildUpdateSqlInfo(this, entity, whereBuilder, updateColumnNames).getSql());
...
//        Utils.LogE(sql);
    ...
    class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public DatabaseHelper(Context context) {
            super(context, daoConfig.getDbName(), null, daoConfig.getDbVersion());
