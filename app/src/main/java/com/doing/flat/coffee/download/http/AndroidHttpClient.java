...
package com.doing.flat.coffee.download.http;
...
public final class AndroidHttpClient implements HttpClient {
    ...
    private static final int SOCKET_OPERATION_TIMEOUT = 1200 * 1000;
     ...
     * @throws IllegalArgumentException if {@code dateString} is not a date or of an unsupported
     *                                  format.
     */
